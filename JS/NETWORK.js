// Networking by node and node operation
// We can simulate the network by simply launching miltiple instances of the Electron application
// The applications should be able to locate some local server and from this local server communicate
